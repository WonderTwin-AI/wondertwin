// twin-linear is a WonderTwin twin that simulates the Linear GraphQL API.
// It handles issues, teams, projects, cycles, workflow states, labels,
// comments, attachments, relations, documents, webhooks, and more.
//
// SDK compatibility target: @linear/sdk
// Integration method: Override API base URL
package main
...
func main() {
	cfg := twincore.ParseFlags("twin-linear")
	if cfg.Port == 0 {
		cfg.Port = 4121
	}
	...
	twin.Logger.Info("twin-linear ready", "port", cfg.Port)
