// twin-hubspot is a WonderTwin twin that simulates the HubSpot CRM API.
// It handles CRM objects (contacts, companies, deals, tickets, engagements),
// associations, properties, pipelines, search, owners, lists, webhooks, and forms.
//
// SDK compatibility target: github.com/clarkmcc/go-hubspot, @hubspot/api-client
...
func main() {
	cfg := twincore.ParseFlags("twin-hubspot")
	if cfg.Port == 0 {
		cfg.Port = 4122
	}
	...
	twin.Logger.Info("twin-hubspot ready", "port", cfg.Port)
