...
Want an emulator we do not have, or found one behaving differently from the real
service? See [CONTRIBUTING.md](CONTRIBUTING.md). Code contributions are paused
while the architecture is reworked; requests and bug reports are not.
